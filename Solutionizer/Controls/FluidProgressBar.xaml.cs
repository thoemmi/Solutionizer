...
namespace Solutionizer.Controls {
    ...
    /// </summary>
    /// <remarks>
    /// This control is copied from http://wpfspark.codeplex.com. This single control
    /// is not reason enough to depend on the entire library.
    /// </remarks>
    public partial class FluidProgressBar : UserControl, IDisposable {
        ...
        private static void OnDelayChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            var bar = (FluidProgressBar) d;
            var oldDelay = (Duration) e.OldValue;
            var newDelay = bar.Delay;
            bar.OnDelayChanged(oldDelay, newDelay);
        }
        ...
        private static void OnDotWidthChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            var newDotWidth = bar.DotWidth;
            bar.OnDotWidthChanged(oldDotWidth, newDotWidth);
        }
        ...
        private static void OnDotHeightChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            var newDotHeight = bar.DotHeight;
            bar.OnDotHeightChanged(oldDotHeight, newDotHeight);
        }
        ...
        private static void OnDotRadiusXChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            var newDotRadiusX = bar.DotRadiusX;
            bar.OnDotRadiusXChanged(oldDotRadiusX, newDotRadiusX);
        }
        ...
        private static void OnDotRadiusYChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            var newDotRadiusY = bar.DotRadiusY;
            bar.OnDotRadiusYChanged(oldDotRadiusY, newDotRadiusY);
        }
        ...
        private static void OnDurationAChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            var newDurationA = bar.DurationA;
            bar.OnDurationAChanged(oldDurationA, newDurationA);
        }
        ...
        private static void OnDurationBChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            var newDurationB = bar.DurationB;
            bar.OnDurationBChanged(oldDurationB, newDurationB);
        }
        ...
        private static void OnDurationCChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            var newDurationC = bar.DurationC;
            bar.OnDurationCChanged(oldDurationC, newDurationC);
        }
        ...
        private static void OnKeyFrameAChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            var newKeyFrameA = bar.KeyFrameA;
            bar.OnKeyFrameAChanged(oldKeyFrameA, newKeyFrameA);
        }
        ...
        private static void OnKeyFrameBChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            var newKeyFrameB = bar.KeyFrameB;
            bar.OnKeyFrameBChanged(oldKeyFrameB, newKeyFrameB);
        }
        ...
        private static void OnOscillateChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            var newOscillate = bar.Oscillate;
            bar.OnOscillateChanged(oldOscillate, newOscillate);
        }
        ...
        protected virtual void OnOscillateChanged(bool oldOscillate, bool newOscillate) {
            if (_storyboard != null) {
                StopFluidAnimation();
                _storyboard.AutoReverse = newOscillate;
                _storyboard.Duration = newOscillate ? ReverseDuration : TotalDuration;
                StartFluidAnimation();
            }
        }
        ...
        private static void OnReverseDurationChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            var newReverseDuration = bar.ReverseDuration;
            bar.OnReverseDurationChanged(oldReverseDuration, newReverseDuration);
        }
        ...
        protected virtual void OnReverseDurationChanged(Duration oldReverseDuration, Duration newReverseDuration) {
            if ((_storyboard != null) && (Oscillate)) {
                _storyboard.Duration = newReverseDuration;
                RestartStoryboardAnimation();
            }
        }
        ...
        private static void OnTotalDurationChanged(DependencyObject d, DependencyPropertyChangedEventArgs e) {
            ...
            var newTotalDuration = bar.TotalDuration;
            bar.OnTotalDurationChanged(oldTotalDuration, newTotalDuration);
        }
        ...
        protected virtual void OnTotalDurationChanged(Duration oldTotalDuration, Duration newTotalDuration) {
            if ((_storyboard != null) && (!Oscillate)) {
                _storyboard.Duration = newTotalDuration;
                RestartStoryboardAnimation();
            }
        }
        ...
        private void StartFluidAnimation() {
            if (_storyboard != null && !_isStoryboardRunning) {
                _storyboard.Begin();
        ...
        private void StopFluidAnimation() {
            if (_storyboard != null && _isStoryboardRunning) {
                ...
                _storyboard.SeekAlignedToLastTick(TimeSpan.FromSeconds(0));
                _storyboard.Stop();
        ...
        private void GetKeyFramesFromStoryboard() {
            _storyboard = (Storyboard) Resources["FluidStoryboard"];
            if (_storyboard != null) {
                foreach (Timeline timeline in _storyboard.Children) {
                    var animation = timeline as DoubleAnimationUsingKeyFrames;
                    if (animation != null) {
                        var targetName = Storyboard.GetTargetName(animation);
                        ProcessDoubleAnimationWithKeys(animation, !targetName.StartsWith("Trans"));
                    }
                }
            }
        }
        ...
        private void UpdateKeyTime(int key, Duration newDuration) {
            if (_keyFrameMap.ContainsKey(key)) {
                ...
                foreach (var frame in _keyFrameMap[key].KeyFrames) {
                    if (frame is LinearDoubleKeyFrame) {
                        frame.SetValue(DoubleKeyFrame.KeyTimeProperty, newKeyTime);
                    } else if (frame is EasingDoubleKeyFrame) {
                        frame.SetValue(DoubleKeyFrame.KeyTimeProperty, newKeyTime);
                    }
                }
        ...
        private void UpdateTimelineDelay(Duration newDelay) {
            ...
            if (_storyboard != null) {
                for (var i = 0; i < _storyboard.Children.Count; i++) {
                    ...
                    var timeline = _storyboard.Children[i] as DoubleAnimationUsingKeyFrames;
                    if (timeline != null) {
